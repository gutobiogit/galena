  ...
  function showUserCreateBox() {
    Swal.fire({
      ...
      html:
        ...
        '<input id="email" class="swal2-input" placeholder="CPF">' +
        '<input id="email" class="swal2-input" placeholder="Telefone">'+
        '<input id="email" class="swal2-input" placeholder="Data">'+
        '<input id="email" class="swal2-input" placeholder="End">',
      focusConfirm: false,
      preConfirm: () => {
        Swal.fire('ERROR');
        userCreate();
