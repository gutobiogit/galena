class ErrorFixer:
    ...
    def cpf_fixer(cls, cpf):
        ...
        if len(cpf_clean) == 11:
            return cpf_clean[:3] + "." + cpf_clean[3:6] + "." + cpf_clean[6:9] + "-" + cpf_clean[9:]
        else:
    ...
    def telephone_fixer(cls, telephone):
        ...
        if 8 < len(telephone_clean) < 15:
            return "(" + telephone_clean[:2] + ") " + telephone_clean[2:6] + "-" + telephone_clean[6:]
        else:
            return "(00) 0000-0000"
    ...
    def birthday_fixer(cls, birthday):
        ...
        if len(birthday_clean) == 19:
            return birthday_clean[8:10] + "/" + birthday_clean[5:7] + "/" + birthday_clean[0:4]
        else:
            return "00/00/0000"
